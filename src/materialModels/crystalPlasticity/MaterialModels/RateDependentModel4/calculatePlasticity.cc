...
////// increment. The tangent modulus construction is bit more involved
//// and similar to the one implemented in MaterialModels/RateDependentModel2 without the exponential. .
