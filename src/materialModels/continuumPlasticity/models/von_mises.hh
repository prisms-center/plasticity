...
namespace PRISMS
{
    ...
    class von_mises_f : public PSimpleBase< VarContainer, double>
    {
        ...
        {
            return  -8.1649658092772603e-01*var[3]+8.1649658092772603e-01*var[4]+pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),(1.0/2.0));
        };
    ...
    class von_mises_grad_0 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return (1.0/2.0)*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0))*( 1.3333333333333333e+00*var[0]+-6.6666666666666663e-01*var[1]+-6.6666666666666663e-01*var[2]);
        };
    ...
    class von_mises_grad_1 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return (1.0/2.0)*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0))*( -6.6666666666666663e-01*var[0]+1.3333333333333333e+00*var[1]+-6.6666666666666663e-01*var[2]);
        };
    ...
    class von_mises_grad_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return (1.0/2.0)*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0))*( -6.6666666666666663e-01*var[0]+-6.6666666666666663e-01*var[1]+1.3333333333333333e+00*var[2]);
        };
    ...
    class von_mises_hess_0_0 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return -pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(3.0/2.0))*pow( 1.3333333333333333e+00*var[0]+-6.6666666666666663e-01*var[1]+-6.6666666666666663e-01*var[2],2.0)/4.0+6.6666666666666663e-01*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0));
        };
    ...
    class von_mises_hess_0_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return -pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(3.0/2.0))*( -6.6666666666666663e-01*var[0]+-6.6666666666666663e-01*var[1]+1.3333333333333333e+00*var[2])*( 1.3333333333333333e+00*var[0]+-6.6666666666666663e-01*var[1]+-6.6666666666666663e-01*var[2])/4.0+-3.3333333333333331e-01*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0));
        };
    ...
    class von_mises_hess_1_1 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return -pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(3.0/2.0))*pow( -6.6666666666666663e-01*var[0]+1.3333333333333333e+00*var[1]+-6.6666666666666663e-01*var[2],2.0)/4.0+6.6666666666666663e-01*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0));
        };
    ...
    class von_mises_hess_1_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  -3.3333333333333331e-01*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0))-pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(3.0/2.0))*( -6.6666666666666663e-01*var[0]+1.3333333333333333e+00*var[1]+-6.6666666666666663e-01*var[2])*( -6.6666666666666663e-01*var[0]+-6.6666666666666663e-01*var[1]+1.3333333333333333e+00*var[2])/4.0;
        };
    ...
    class von_mises_hess_2_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return -pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(3.0/2.0))*pow( -6.6666666666666663e-01*var[0]+-6.6666666666666663e-01*var[1]+1.3333333333333333e+00*var[2],2.0)/4.0+6.6666666666666663e-01*pow( pow( -3.3333333333333331e-01*var[0]+-3.3333333333333331e-01*var[1]+6.6666666666666663e-01*var[2],2.0000000000000000e+00)+pow( -3.3333333333333331e-01*var[0]+6.6666666666666663e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00)+pow( 6.6666666666666663e-01*var[0]+-3.3333333333333331e-01*var[1]+-3.3333333333333331e-01*var[2],2.0000000000000000e+00),-(1.0/2.0));
        };
