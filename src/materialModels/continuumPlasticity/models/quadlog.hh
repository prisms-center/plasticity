...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        {
            return "(log(lambda2)^(2.0)+log(lambda1)^(2.0)+log(lambda3)^(2.0))*mu+(0.5)*lambda*(log(lambda1)+log(lambda2)+log(lambda3))^(2.0)+(0.5)*K*alpha^(2.0)";
        }

        std::string latex() const
        {
            return " {(\\ln(lambda3)^{{(2.0)}}+\\ln(lambda2)^{{(2.0)}}+\\ln(lambda1)^{{(2.0)}})} \\mu+{(0.5)}  K \\alpha^{{(2.0)}}+{(0.5)}  \\lambda {(\\ln(lambda1)+\\ln(lambda2)+\\ln(lambda3))}^{{(2.0)}}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(0.5)*(log(lambda1)+log(lambda2)+log(lambda3))^(2.0)";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "log(lambda2)^(2.0)+log(lambda1)^(2.0)+log(lambda3)^(2.0)";
        }

        std::string latex() const
        {
            return "\\ln(lambda1)^{{(2.0)}}+\\ln(lambda3)^{{(2.0)}}+\\ln(lambda2)^{{(2.0)}}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(2.0)*log(lambda1)*mu*lambda1^(-1)+lambda*(log(lambda3)+log(lambda1)+log(lambda2))*lambda1^(-1)";
        }

        std::string latex() const
        {
            return "{(2.0)}  \\mu \\frac{1}{lambda1} \\ln(lambda1)+\\frac{ {(\\ln(lambda2)+\\ln(lambda3)+\\ln(lambda1))} \\lambda}{lambda1}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(log(lambda2)+log(lambda3)+log(lambda1))*lambda2^(-1)*lambda+(2.0)*log(lambda2)*lambda2^(-1)*mu";
        }

        std::string latex() const
        {
            return "{(2.0)}  \\frac{1}{lambda2} \\mu \\ln(lambda2)+\\frac{ \\lambda {(\\ln(lambda1)+\\ln(lambda2)+\\ln(lambda3))}}{lambda2}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(2.0)*log(lambda3)*lambda3^(-1)*mu+lambda*lambda3^(-1)*(log(lambda3)+log(lambda1)+log(lambda2))";
        }

        std::string latex() const
        {
            return "{(2.0)}  \\mu \\frac{1}{lambda3} \\ln(lambda3)+\\frac{ {(\\ln(lambda1)+\\ln(lambda2)+\\ln(lambda3))} \\lambda}{lambda3}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(log(lambda1)+log(lambda2)+log(lambda3))*lambda1^(-1)";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string latex() const
        {
            return "\\frac{\\ln(lambda2)+\\ln(lambda3)+\\ln(lambda1)}{lambda2}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "(log(lambda3)+log(lambda1)+log(lambda2))*lambda1^(-1)";
        }

        std::string latex() const
        {
            return "\\frac{\\ln(lambda2)+\\ln(lambda3)+\\ln(lambda1)}{lambda1}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "-(2.0)*lambda1^(-2)*log(lambda1)*mu+(2.0)*lambda1^(-1)*lambda1^(-1)*mu+lambda1^(-2)*lambda-lambda1^(-2)*(log(lambda3)+log(lambda1)+log(lambda2))*lambda";
        }

        std::string latex() const
        {
            return "\\frac{\\lambda}{lambda1^{2}}-{(2.0)} \\frac{ \\ln(lambda1) \\mu}{lambda1^{2}}-\\frac{ \\lambda {(\\ln(lambda1)+\\ln(lambda2)+\\ln(lambda3))}}{lambda1^{2}}+{(2.0)} \\frac{\\frac{\\mu}{lambda1}}{lambda1}";
        }
    ...
    public:
        ...
        std::string sym() const
        {
            return "lambda1^(-1)*lambda*lambda3^(-1)";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "lambda2^(-2)*lambda-lambda2^(-2)*lambda*(log(lambda3)+log(lambda1)+log(lambda2))+(2.0)*lambda2^(-1)*mu*lambda2^(-1)-(2.0)*lambda2^(-2)*mu*log(lambda2)";
        }

        std::string latex() const
        {
            return "-\\frac{ {(\\ln(lambda1)+\\ln(lambda2)+\\ln(lambda3))} \\lambda}{lambda2^{2}}+\\frac{\\lambda}{lambda2^{2}}-{(2.0)} \\frac{ \\mu \\ln(lambda2)}{lambda2^{2}}+{(2.0)} \\frac{\\frac{\\mu}{lambda2}}{lambda2}";
        }
...
>>>>>>> 1853fc05524906a2a2d829468a5c2e263978073c
    ...
    public:
        ...
        std::string sym() const
        {
            return "-lambda*(log(lambda1)+log(lambda2)+log(lambda3))*lambda3^(-2)-(2.0)*lambda3^(-2)*mu*log(lambda3)+lambda*lambda3^(-2)+(2.0)*lambda3^(-1)*mu*lambda3^(-1)";
        }

        std::string latex() const
        {
            return "-{(2.0)} \\frac{ \\ln(lambda3) \\mu}{lambda3^{2}}-\\frac{ {(\\ln(lambda2)+\\ln(lambda3)+\\ln(lambda1))} \\lambda}{lambda3^{2}}+\\frac{\\lambda}{lambda3^{2}}+{(2.0)} \\frac{\\frac{\\mu}{lambda3}}{lambda3}";
        }
