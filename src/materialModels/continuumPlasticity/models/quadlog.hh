...
namespace PRISMS
{
    ...
    class quadlog_f : public PSimpleBase< VarContainer, double>
    {
        ...
        {
            return  ( pow(log(var[2]),2.0000000000000000e+00)+pow(log(var[4]),2.0000000000000000e+00)+pow(log(var[3]),2.0000000000000000e+00))*var[1]+5.0000000000000000e-01*pow(var[6],2.0000000000000000e+00)*var[5]+5.0000000000000000e-01*var[0]*pow( log(var[2])+log(var[3])+log(var[4]),2.0000000000000000e+00);
        };
    ...
    class quadlog_grad_0 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return 5.0000000000000000e-01*pow( log(var[2])+log(var[3])+log(var[4]),2.0000000000000000e+00);
        };
    ...
    class quadlog_grad_1 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  pow(log(var[2]),2.0000000000000000e+00)+pow(log(var[4]),2.0000000000000000e+00)+pow(log(var[3]),2.0000000000000000e+00);
        };
    ...
    class quadlog_grad_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  2.0000000000000000e+00*log(var[2])*1.0/(var[2])*var[1]+1.0/var[2]*var[0]*( log(var[2])+log(var[3])+log(var[4]));
        };
    ...
    class quadlog_grad_3 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  1.0/var[3]*var[0]*( log(var[2])+log(var[3])+log(var[4]))+2.0000000000000000e+00*1.0/(var[3])*log(var[3])*var[1];
        };
    ...
    class quadlog_grad_4 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  var[0]*( log(var[2])+log(var[3])+log(var[4]))/var[4]+2.0000000000000000e+00*log(var[4])*var[1]*1.0/(var[4]);
        };
    ...
    class quadlog_hess_2_2 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return -1.0/(var[2]*var[2])*var[0]*( log(var[2])+log(var[3])+log(var[4]))+-2.0000000000000000e+00*1.0/(var[2]*var[2])*log(var[2])*var[1]+2.0000000000000000e+00*1.0/var[2]*1.0/(var[2])*var[1]+1.0/(var[2]*var[2])*var[0];
        };
    ...
    class quadlog_hess_3_3 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  1.0/(var[3]*var[3])*var[0]+2.0000000000000000e+00*1.0/(var[3])/var[3]*var[1]-1.0/(var[3]*var[3])*var[0]*( log(var[2])+log(var[3])+log(var[4]))+-2.0000000000000000e+00*1.0/(var[3]*var[3])*log(var[3])*var[1];
        };
    ...
    class quadlog_hess_4_4 : public PSimpleBase< VarContainer, double>
    {
        double eval( const VarContainer &var) const
        {
            return  var[0]/(var[4]*var[4])-var[0]*( log(var[2])+log(var[3])+log(var[4]))/(var[4]*var[4])+-2.0000000000000000e+00*1.0/(var[4]*var[4])*log(var[4])*var[1]+2.0000000000000000e+00*1.0/var[4]*var[1]*1.0/(var[4]);
        };
