...
namespace PRISMS
{
        ...
        void PLibrary::checkout( std::string name, PSimpleFunction< std::vector<double>, double > &simplefunc)
        {
            ...
            if( name == "hardening_f") simplefunc = PSimpleFunction< std::vector<double>, double >( hardening_f< std::vector<double> >() );
            if( name == "hardening_grad_0") simplefunc = PSimpleFunction< std::vector<double>, double >( hardening_grad_0< std::vector<double> >() );
            if( name == "hardening_hess_0_0") simplefunc = PSimpleFunction< std::vector<double>, double >( hardening_hess_0_0< std::vector<double> >() );
        ...
        void PLibrary::checkout( std::string name, PSimpleFunction< double*, double > &simplefunc)
        {
            ...
            if( name == "hardening_f") simplefunc = PSimpleFunction< double*, double >( hardening_f< double* >() );
            if( name == "hardening_grad_0") simplefunc = PSimpleFunction< double*, double >( hardening_grad_0< double* >() );
            if( name == "hardening_hess_0_0") simplefunc = PSimpleFunction< double*, double >( hardening_hess_0_0< double* >() );
        ...
        void PLibrary::checkout( std::string name, PFunction< std::vector<double>, double > &func)
        {
            ...
            if( name == "hardening") func = PFunction< std::vector<double>, double >( hardening< std::vector<double> >() );
        ...
        void PLibrary::checkout( std::string name, PFunction< double*, double > &func)
        {
            ...
            if( name == "hardening") func = PFunction< double*, double >( hardening< double* >() );
        ...
        void PLibrary::checkout( std::string name, PSimpleBase< std::vector<double>, double > *&simplefunc)
        {
            ...
            if( name == "hardening_f") simplefunc = new hardening_f< std::vector<double> >();
            if( name == "hardening_grad_0") simplefunc = new hardening_grad_0< std::vector<double> >();
            if( name == "hardening_hess_0_0") simplefunc = new hardening_hess_0_0< std::vector<double> >();
        ...
        void PLibrary::checkout( std::string name, PSimpleBase< double*, double > *&simplefunc)
        {
            ...
            if( name == "hardening_f") simplefunc = new hardening_f< double* >();
            if( name == "hardening_grad_0") simplefunc = new hardening_grad_0< double* >();
            if( name == "hardening_hess_0_0") simplefunc = new hardening_hess_0_0< double* >();
        ...
        void PLibrary::checkout( std::string name, PFuncBase< std::vector<double>, double > *&func)
        {
            ...
            if( name == "hardening") func = new hardening< std::vector<double> >();
        ...
        void PLibrary::checkout( std::string name, PFuncBase< double*, double > *&func)
        {
            ...
            if( name == "hardening") func = new hardening< double* >();
