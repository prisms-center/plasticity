...
#define enableAdaptiveTimeStepping true //Flag to enable adaptive time steps
...
#define modelMaxPlasticSlipL2Norm 2.0 // L2-Norm of plastic slip strain-used for load-step adaptivity
