...
#define powerLawExponent 1.0  //a
#define initialSlipResistance 200.0 // CRSS s0(MPa)
#define saturationStress 500.0 //s_s(MPa)
#define initialHardeningModulus 1500.0 //s_s(MPa) //h0(MPa)
